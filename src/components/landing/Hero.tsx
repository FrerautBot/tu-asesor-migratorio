      ...
      >
        <div className="max-w-3xl">
          ...
          >
            ...
            <Link
              href="#qualifier"
              className="inline-flex items-center justify-center px-8 py-4 rounded-xl border border-white/15 bg-white/[0.03] backdrop-blur-sm text-white font-semibold hover:bg-white/[0.08] hover:border-white/25 transition-all duration-300 text-center min-h-[44px]"
            >
              Ver servicios
            </Link>
          </motion.div>
